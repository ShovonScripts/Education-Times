...
@section('content')
    ...
    <div class="mt-6 bg-white dark:bg-[#1a1a1a] border border-[#e0e0e0] dark:border-[#333] p-6 text-center">
        <p class="text-sm text-[#999]">SEO Analysis will be available after saving the Post</p>
        <p class="text-xs text-[#999] mt-1">Open the Edit page to view the SEO analysis under Details</p>
    </div>
