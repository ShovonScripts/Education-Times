...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-xs text-[#999] mt-0.5">বর্তমান robots.txt Content নিচে দেখানো হল — সার্চ ইঞ্জিন ক্রলারদের জন্য নির্দেশNo</p>
    </div>
...
<div class="admin-card p-6">
    <form method="POST" action="{{ route('admin.seo.robots.update') }}">
        ...
        <p class="text-xs text-[#999] mt-2">সতর্কতা: ভুল কনফিগারেশন সার্চ ইঞ্জিন থেকে আপNoর সাইট ব্লক করতে পারে।</p>
