...
<form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">সাইটের Name (বাংলা)</label>
                    <input type="text" name="site_name_bn" value="{{ old('site_name_bn', $settings['site_name_bn']->value ?? '') }}" class="admin-input w-full">
                </div>
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">সাইটের Name (ইংরেজি)</label>
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">ফুটার Logo</label>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="flex items-center gap-2 text-sm">
                        ...
                        <span>প্রিলোডার Active করুন</span>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="admin-card p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">ঠিকাNo</label>
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-4">সোশ্যাল Media Link</h2>
            <div class="space-y-4">
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-4">ফুটার Content</h2>
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-xs text-[#999] mt-1">HTML Tags ব্যবহার করা যাবে</p>
                </div>
                <div>
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">ফুটার ট্যাগলাইন</label>
        ...
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-1">সম্পাদকীয় পরিচিতি</h2>
            <p class="text-xs text-[#999] mb-4">ফুটারের "সম্পাদকীয়" বক্সে যে নাম দেখাবে</p>
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-[#666] mb-1">সম্পাদকের নাম</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-[#666] mb-1">পদবি</label>
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">প্রকাশক</label>
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-1">হোমপেজ সেকশন</h2>
            <p class="text-xs text-[#999] mb-4">হোমপেজে কোন ক্যাটেগরি থেকে কন্টেন্ট আসবে তা নিয়ন্ত্রণ</p>
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">ব্রেকিং নিউজ লেবেল</label>
        ...
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-1">নিউজলেটার সেকশন</h2>
            <p class="text-xs text-[#999] mb-4">হোমপেজে নিউজলেটার ব্যানারের টেক্সট</p>
            <div class="space-y-4">
                <div>
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">বিবরণ</label>
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            ...
            <p class="text-xs text-[#999] mb-4">এই Settings .env Fileের মান ওভাররাইড করবে No। প্রকৃত মেইল পাঠানোর জন্য .env File Update।</p>
            <div class="space-y-4">
                <div>
    ...
    <div class="max-w-2xl space-y-6">
        <div class="admin-card p-6">
            <h2 class="text-sm font-bold mb-4">SEO & অ্যাNoলিটিক্স</h2>
            <div class="space-y-4">
                <div>
                ...
                <div>
                    <label class="block text-xs font-medium text-[#666] mb-1">মেটা Keywordsস</label>
            ...
            <div class="space-y-4">
                <div>
                    <label class="flex items-center gap-3 text-sm">
                        ...
                        <span>মেইন্টেন্যান্স মোড Active করুন</span>
                    </label>
                    <p class="text-xs text-[#999] mt-1">Active করলে শুধু এডমিনরা সাইট দেখতে পারবেন</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex justify-end mt-6 max-w-2xl">
        <button type="submit" class="btn-primary">Settings সংরক্ষণ</button>
    </div>
    @endif
</form>
...
<div class="max-w-2xl space-y-6" id="toolsTab">
    <div class="admin-card p-6">
        <h2 class="text-sm font-bold mb-4">ক্যাশ Manageমেন্ট</h2>
            ...
            <form method="POST" action="{{ route('admin.settings.clear-data') }}" data-confirm-form>
                ...
                <div class="flex items-center justify-between p-4 bg-[#fafafa] dark:bg-[#2a2a2a] border border-[#e0e0e0] dark:border-[#444]">
                    <div>
                        ...
                        <p class="text-xs text-[#999] mt-0.5">Pages ভিউ ও Activity লগের ডাটা মুছে ফেলে</p>
                    </div>
                    <button type="button" class="bg-[#666] text-white text-xs font-medium px-4 py-2 hover:bg-[#0d0d0d] transition whitespace-nowrap" data-confirm-trigger="Pages ভিউ ও Activity লগের সব ডাটা সাফ করবেন?">ডাটা সাফ</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#1e1e1e] border border-[#e0e0e0] dark:border-[#333] w-full max-w-sm mx-4 shadow-2xl">
        <div class="p-5">
            ...
            <div class="flex items-center justify-end gap-2 mt-5 pt-4 border-t border-[#e0e0e0] dark:border-[#333]">
                ...
                <button type="button" id="confirmSubmit" class="px-4 py-2 text-xs font-medium text-white bg-[#E02020] hover:bg-red-700 transition">Yes, সাফ করুন</button>
            </div>
        </div>
    </div>
</div>
