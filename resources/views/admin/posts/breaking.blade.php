...
<div class="flex items-center justify-between mb-5">
    <div>
        ...
        <p class="text-xs text-[#999] mt-0.5">{{ $articles->total() }} Breaking News Items</p>
    </div>
    ...
    <table class="w-full text-sm">
        <thead class="admin-table-header">
            <tr>
                ...
                <th class="text-left p-3 font-semibold text-[#666] text-xs uppercase tracking-wider hidden lg:table-cell">Published</th>
        ...
        <tbody class="divide-y divide-[#e0e0e0] dark:divide-[#333]">
                ...
                <td class="p-3 text-right">
                    <div class="flex items-center justify-end gap-1">
                        ...
                        <form method="POST" action="{{ route('admin.posts.toggle-flag', $article) }}" class="inline">
                            ...
                            <button type="submit" class="text-red-500 hover:text-red-700 p-1.5 transition" title="Remove from Breaking">
            ...
            @empty
            <tr><td colspan="4" class="p-10 text-center text-sm text-[#999]">No Breaking News</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
