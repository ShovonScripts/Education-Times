...
<div class="flex items-center justify-between mb-5">
    <div>
        ...
        <p class="text-xs text-[#999] mt-0.5">{{ $counts['submitted'] }} টি Posts পর্যালোচNoর অপেক্ষায়</p>
    </div>
...
<div class="admin-card overflow-hidden">
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-[#e0e0e0]">
            ...
            <tr class="admin-hover-row">
                ...
                <td class="p-3 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.articles.edit', $article) }}" class="bg-[#0d0d0d] dark:bg-[#333] text-white px-4 py-1.5 text-xs font-medium hover:bg-black dark:hover:bg-[#444] transition">পর্যালোচNo</a>
            ...
            @empty
            <tr><td colspan="4" class="p-10 text-center text-sm text-[#999]">কোনো পেন্ডিং Posts নেই</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
